...
The eleven native supports bind to eleven distinct direction keys. Each remains an independent `new_signal`; none `reinforces` another. The evidence adds early signals and leaves the Field Map unchanged.
